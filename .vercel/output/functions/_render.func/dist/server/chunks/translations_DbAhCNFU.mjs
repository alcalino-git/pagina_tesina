...
import { A as AstroError, ao as UnknownContentCollectionError, b as createComponent, ap as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, aq as renderUniqueStylesheet, ar as renderScriptElement, as as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_CsOMacnS.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BjYptqEp.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CdAJ3u_8.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_7RyT4-mB.mjs');
...
const starlightConfig = {"social":{},"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Introducción","translations":{},"collapsed":false,"autogenerate":{"directory":"contenido/introduccion"}},{"label":"Marco teórico","translations":{},"collapsed":false,"autogenerate":{"directory":"contenido/marco_teorico"}},{"label":"Desarrollo","translations":{},"collapsed":false,"autogenerate":{"directory":"contenido/desarrollo"}},{"label":"Resultados","translations":{},"collapsed":false,"autogenerate":{"directory":"contenido/resultados"}},{"label":"Otros","translations":{},"collapsed":false,"autogenerate":{"directory":"contenido/anexos"}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Proyecto de Tesina"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///home/alcalino/Desktop/pagina_tesina/","srcDir":"file:///home/alcalino/Desktop/pagina_tesina/src/","trailingSlash":"ignore"};
